 ...
 * @property string $TotalShippingCost
 ...
 * @property string $Total_Payment_Authorized
 ...
 * @property string $SalesTax1
 * @property string $SalesTax2
 * @property string $SalesTax3
 ...
 * @property string $Custom_Field_FFLINST
 * @property string $FreeShippingDiscountApplied
 * @property string $Custom_Field_paymentdate
 * @property string $Custom_Field_remainingfee
 * @property string $Custom_Field_layawayterms

...
use Core\Database\Eloquent\Builder as EloquentBuilder;
...
class Builder
{
     ...
     *
     * @param  \Core\Database\VolusionConnection $connection
    ...
    {
        $this->connection->setForceRequest($bool);
    }
    /**
     ...
     * @return \Core\Database\Query\Builder|static
     */
     ...
     *
     * @param  \Closure|\Core\Database\Query\Builder|string $query
     * @param  string $as
     * @return \Core\Database\Query\Builder|static
     *
     ...
     *
     * @param  string $column
     * @param  \Core\Database\Query\Builder|static $query
     * @param  string $boolean
     * @param  bool $not
     * @return $this
     */
     ...
     *
     * @param  \Core\Database\Query\Builder|\Closure $query
     * @param  bool $all
     * @return \Core\Database\Query\Builder|static
     */
     ...
     *
     * @param  mixed $value
     * @return \Core\Database\Query\Expression
     */
     ...
     *
     * @return \Core\Database\ConnectionInterface
     */
     ...
     *
     * @return \Core\Database\Query\Processors\Processor
     */
     ...
     *
     * @return \Core\Database\Query\Grammars\Grammar
     */

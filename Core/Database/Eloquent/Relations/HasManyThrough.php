...
use Core\Database\Eloquent\SoftDeletes;
use Core\Database\Eloquent\ModelNotFoundException;
...
class HasManyThrough extends Relation
{
     ...
     *
     * @param  \Core\Database\Eloquent\Builder|null  $query
     * @return void
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \Core\Database\Eloquent\Model|\Core\Database\Eloquent\Collection|null
     */
     ...
     *
     * @param  \Core\Database\Eloquent\Builder  $query
     * @param  \Core\Database\Eloquent\Builder  $parentQuery
